...
class GUI extends GraficoUI {
    ...
    protected void InitMatrizSujeira(JPanel Sala) {
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
                Sujeiras[j][i] = new JLabel(new ImageIcon("sujeira.png"));
    ...
    protected void MontarLayout() {
        ...
        Sala.setBackground(new Color(201, 193, 182));
        InitAspirador(Sala);
    ...
    public void MostrarCaminho(int Linha, int Coluna) {
        ...
        Sujeiras[Linha][Coluna].setVisible(true);
        Sujeiras[Linha][Coluna].setIcon(new ImageIcon("seamless-vector-pattern-with-hand-drawn-traditional-motifs-of-italy-vector-id899934486.png"));
    }
